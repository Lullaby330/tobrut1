...
#Bot token @Botfather
TG_BOT_TOKEN = os.environ.get("TG_BOT_TOKEN", "6566973544:AAEMddtQlgJsKUFO8MuPK7WUe9Q4SpdQw_8")
...
try:
    ADMINS=[]
    for x in (os.environ.get("ADMINS",  "1549521661").split()):
        ADMINS.append(int(x))
except ValueError:
